...
import { ArrowRight, BookOpen, Clock, Quote } from "lucide-react"
		...
		<div className="container py-10">
			<div className="max-w-2xl">
				...
				<p className="mt-3 text-muted-foreground">
					Những lộ trình minh hoạ và bài viết ngắn giúp bạn nhìn nghề nghiệp
					thực tế hơn, trước khi đưa ra lựa chọn cho riêng mình.
				</p>
			</div>
